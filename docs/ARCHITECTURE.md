...
is INTERNAL_AUDIT_COMPLETE. External Implementation Review is PENDING, so
...
INTERNAL_AUDIT_COMPLETE. External Implementation Review is PENDING.
...
Review is PENDING, and Phase 11 is NOT COMPLETE.
