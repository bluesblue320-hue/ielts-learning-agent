...
START
  ...
  -> External Design Review [APPROVED]
  -> P9-03 Versioned Knowledge Schemas [READY]
  -> P9-04 Official Writing Task 2 Knowledge Snapshot v1 [NOT_STARTED]
  -> P9-05 Deterministic Structured Retriever [NOT_STARTED]
  -> P9-06 Existing Rubric Provenance & Compatibility Audit [NOT_STARTED]
  -> P9-07 Grounded Learner Guidance Service [NOT_STARTED]
  -> P9-08 Knowledge-Grounded Practice Generation [NOT_STARTED]
  -> P9-09 Public Knowledge / Guidance API [NOT_STARTED]
  -> P9-10 Chinese-First Grounded Explanation UX [NOT_STARTED]
